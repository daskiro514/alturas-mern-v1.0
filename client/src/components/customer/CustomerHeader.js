...
const CustomerHeader = ({ currentPage, setCurrentPage, logout }) => {
      ...
      <div className='col-lg-10 col-md-8'>
        <div className='d-flex flex-row justify-content-between'>
          <div className='d-flex align-items-center'>
            <div className={'d-flex align-items-center mr-4 ' + (currentPage === 'dashboard' ? 'border-bottom' : '' )} onClick={() => {
              goPage('dashboard')
            }}>
...
export default connect(mapStateToProps, { logout, setCurrentPage })(CustomerHeader)